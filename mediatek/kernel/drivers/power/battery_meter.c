...
int BattThermistorConverTemp(int Res)
{
    ...
    int TBatt_Value=-200,TMP1=0,TMP2=0;
	 ...
	 bm_print(BM_LOG_CRTI, "[BattThermistorConverTemp] %d,%d,%d\n", 
        Res, Batt_Temperature_Table[0].TemperatureR, Batt_Temperature_Table[16].TemperatureR);
...
int BattVoltToTemp(int dwVolt)
{
    ...
    bm_print(BM_LOG_CRTI, "[BattVoltToTemp] %d,%d,%d,%d\n", 
        TRes_temp, TRes, sBaTTMP, dwVolt);
    #else
