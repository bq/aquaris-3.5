...
{    
    ...
    //VCDT_HV_VTH, 7V
    ret_val=pmic_config_interface(CHR_CON1, 0x0F, PMIC_RG_VCDT_HV_VTH_MASK, PMIC_RG_VCDT_HV_VTH_SHIFT); //0x0B
    //VCDT_HV_EN=1
...
{
#if 0//ndef MTK_DISABLE_POWER_ON_OFF_VOLTAGE_LIMITATION
	U32 ret_val;
    U32 reg_val=0;
