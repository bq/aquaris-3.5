...
void GC0309_Sensor_Init(void)
{
	...
	GC0309_write_cmos_sensor(0x14,0x13); //·½Ïò	
	...
	GC0309_write_cmos_sensor(0x62,0x08); 
	...
	///////////////////////////YCP_t///////////////////////////////
	/////////////////////////////////////////////////////////////////////
	GC0309_write_cmos_sensor(0xb1,0x4e); 
	GC0309_write_cmos_sensor(0xb2,0x4e); 
...
/******* 5/11 daemon update for image performance *****************/
	...
	//cc
	GC0309_write_cmos_sensor(0x93,0x42); ///48
	GC0309_write_cmos_sensor(0x94,0x00); 
	GC0309_write_cmos_sensor(0x95,0x04);  ///05
...
BOOL GC0309_set_param_effect(UINT16 para)
{
	...
	switch (para)
	{
		case MEFFECT_OFF:
			...
			GC0309_write_cmos_sensor(0xb3,0x46);  /// 40
...
BOOL GC0309_set_param_banding(UINT16 para)
{
	switch (para)
	{
		case AE_FLICKER_MODE_50HZ:
			...
			GC0309_write_cmos_sensor(0xe7  ,0xc0); 
			GC0309_write_cmos_sensor(0xe8  ,0x04);   //exp level 2  7.69fps  7.14
			GC0309_write_cmos_sensor(0xe9  ,0x60); 
