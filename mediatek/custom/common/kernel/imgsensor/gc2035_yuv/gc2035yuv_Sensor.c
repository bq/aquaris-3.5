...
static kal_bool GC2035_sensor_cap_zsd = KAL_FALSE; //ZSD Capture
...
void GC2035_night_mode(kal_bool enable)
{
		...
		if (GC2035_sensor_cap_state == KAL_FALSE) 
		{
			if (enable) 
			{
				...
				{
					printk("pheobe 2035 night video\n");
				...
				{
					printk("pheobe 2035 night capture preview\n");
					GC2035_write_cmos_sensor(0xfe, 0x01);
					GC2035_write_cmos_sensor(0x3e, 0x60);
					GC2035_write_cmos_sensor(0xfe, 0x00);
				}
			...
			else 
			{
				...
				if (GC2035_VEDIO_encode_mode == KAL_TRUE) 
				{
					printk("pheobe 2035 normal video\n");
					GC2035_write_cmos_sensor(0xfe, 0x01);
				...
				{
					printk("pheobe 2035 normal preview\n");
					GC2035_write_cmos_sensor(0xfe, 0x01);
					GC2035_write_cmos_sensor(0x3e, 0x40);
					GC2035_write_cmos_sensor(0xfe, 0x00);
				}
...
static void GC2035_Sensor_Init(void)
{
	...
	GC2035_write_cmos_sensor(0x17 , 0x17); //[0]mirror [1]flip  0x14
	...
	GC2035_write_cmos_sensor(0x24 , 0x3F); //pad drive  16
	...
	//////lsc/////////////
GC2035_write_cmos_sensor(0xfe , 0x01);
GC2035_write_cmos_sensor(0xc2 , 0x1c);
...
GC2035_write_cmos_sensor(0xba , 0x06);
GC2035_write_cmos_sensor(0xbb , 0x08);
...
GC2035_write_cmos_sensor(0xda , 0x05);
...
GC2035_write_cmos_sensor(0xd4 , 0x0f);
...
GC2035_write_cmos_sensor(0xa2 , 0x80);
	...
	GC2035_write_cmos_sensor(0xc4 , 0xfc);// 0xec  20130219
	...
	GC2035_write_cmos_sensor(0x8d , 0x6c); //awb gain limit R // 0x70  20130219
	...
	////////////YCP//////////
	GC2035_write_cmos_sensor(0xd1 , 0x2d);//saturation_cb // 0x38  20130219
	GC2035_write_cmos_sensor(0xd2 , 0x2d);//saturation_Cr // 0x38  20130219
	GC2035_write_cmos_sensor(0xd3 , 0x40);//contrast Ó // 0x40  20130219
	GC2035_write_cmos_sensor(0xd4 , 0x60);//contrast center 
	GC2035_write_cmos_sensor(0xd5 , 0x00);//luma_offset // 0x00  20130219
	...
	GC2035_write_cmos_sensor(0x97 , 0x85);// edge effect // 0x45  20130219
	////==============RGB Gamma 
	GC2035_write_cmos_sensor(0xfe , 0x02);
...
static void GC2035_Write_More(void)
{
  //////////////For FAE ////////////////
	...
	GC2035_write_cmos_sensor(0xfe , 0x00);
	GC2035_write_cmos_sensor(0xad , 0x7c);
	GC2035_write_cmos_sensor(0xae , 0x85);
	GC2035_write_cmos_sensor(0xaf , 0x88);
}
					  ...
					  MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
	...
	if (GC2035_sensor_cap_zsd == KAL_FALSE) 
		{
			GC2035_Sensor_SVGA();
					  ...
					  MSDK_SENSOR_CONFIG_STRUCT *pSensorConfigData)
{
	...
	switch (ScenarioId)
	{
		...
		case MSDK_SCENARIO_ID_VIDEO_PREVIEW:
			...
			pSensorInfo->SensorClockRisingCount= 1;
...
BOOL GC2035_set_param_exposure(UINT16 para)
{
	...
	switch (para)
	{
		...
		case AE_EV_COMP_00:
			GC2035_SET_PAGE1;
			GC2035_write_cmos_sensor(0x13,0x80);// 0x80  20130219
			GC2035_SET_PAGE0;
		break;
		case AE_EV_COMP_03:
			GC2035_SET_PAGE1;
