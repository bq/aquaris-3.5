...
*
*************************************************************************/
static kal_uint16 GC0329_write_cmos_sensor(kal_uint8 addr, kal_uint8 para)
{
...
*
*************************************************************************/
static kal_uint16 GC0329_read_cmos_sensor(kal_uint8 addr)
{
...
void GC0329_Sensor_Init(void)
{
	...
	GC0329_write_cmos_sensor(0xb7, 0x3d);//48
	...
	////////////////////YCP////////////////////
	GC0329_SET_PAGE0;
	GC0329_write_cmos_sensor(0xd1, 0x2d);//38
	...
	////////////////////AEC////////////////////
			...
			GC0329_write_cmos_sensor(0x2c, 0x80); 
...
BOOL GC0329_set_param_banding(UINT16 para)
{
	switch (para)
	{
		...
		case AE_FLICKER_MODE_60HZ:
			...
			GC0329_write_cmos_sensor(0x2c, 0x44); 
			GC0329_write_cmos_sensor(0x2d, 0x04);   //exp level 0  12.00fps
			GC0329_write_cmos_sensor(0x2e, 0x44); 
			...
			GC0329_write_cmos_sensor(0x32, 0x50); 
			GC0329_SET_PAGE0;
		break;
		default:
		return FALSE;
