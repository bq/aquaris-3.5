...
int tpd_fw_auto_upgrade_with_i_file = 0;//xuqian add
module_param(tpd_fw_auto_upgrade_with_i_file, int, 00664);

int tp_fw_upgrade_prop = 1;//xuqian add
module_param(tp_fw_upgrade_prop, int, 00664);

int tpd_fw_auto_upgradeapp = 0;//xuqian add
module_param(tpd_fw_auto_upgradeapp, int, 00664);
