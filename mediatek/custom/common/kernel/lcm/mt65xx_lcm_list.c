...
extern LCM_DRIVER ili9488_lead_dsi_hvga_lcm_drv;
extern LCM_DRIVER hx8357_dsi_hvga_chuanma_lcm_drv;
extern LCM_DRIVER ili9487_dsi_hvga_aizhuoertai_lcm_drv;
...
#if defined(ILI9488_LEAD_DSI_HVGA)
		&ili9488_lead_dsi_hvga_lcm_drv,
#endif

#if defined(ILI9487_DSI_HVGA_AIZHUOERTAI)
		&ili9487_dsi_hvga_aizhuoertai_lcm_drv,
#endif

#if defined(HX8357_DSI_HVGA_CHUANMA)
		&hx8357_dsi_hvga_chuanma_lcm_drv,
#endif
